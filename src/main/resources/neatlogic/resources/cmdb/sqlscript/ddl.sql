...
CREATE TABLE `cmdb_attrentity`  (
  ...
  `from_cientity_id` bigint NULL DEFAULT NULL COMMENT '所属配置项id',
  `to_cientity_id` bigint NULL DEFAULT NULL COMMENT '引用配置项id',
  `attr_id` bigint NULL DEFAULT NULL COMMENT '属性id',
  `from_ci_id` bigint NULL DEFAULT NULL COMMENT '所属配置项模型id',
  `to_ci_id` bigint NULL DEFAULT NULL COMMENT '引用配置项模型id',
  `transaction_id` bigint NULL DEFAULT NULL COMMENT '事务id',
  `from_index` int NULL DEFAULT NULL COMMENT '数据序号，用于检索时提高效率，只会生成前N条数据的序号',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_from_cientity_id`(`from_cientity_id`, `attr_id`, `to_cientity_id`) USING BTREE,
  INDEX `idx_to_cientity_id`(`to_cientity_id`) USING BTREE,
  INDEX `idx_attr_id`(`attr_id`) USING BTREE,
  INDEX `idx_from_ci_id`(`from_ci_id`) USING BTREE,
  INDEX `idx_to_ci_id`(`to_ci_id`) USING BTREE,
  INDEX `idx_transaction_id`(`transaction_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6114 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb配置项属性实例表';
...
CREATE TABLE `cmdb_attrentity_content`  (
  ...
  `value_hash` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'value值的hash值，用于精确匹配',
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '内容',
  PRIMARY KEY (`hash`) USING BTREE,
  INDEX `idx_value_hash`(`value_hash`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb配置项属性实例内容表';
...
CREATE TABLE `cmdb_attrentity_content_offset`  (
  ...
  `hash` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '内容hash',
  `start` int NULL DEFAULT NULL COMMENT 'start',
  `end` int NULL DEFAULT NULL COMMENT 'end',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_field_id`(`hash`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_attrentity_content_offset';
...
CREATE TABLE `cmdb_attrexpression_rebuild_audit`  (
  ...
  `attr_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '修改了哪些属性，多个属性用逗号分隔',
  `cientity_id_start` bigint NULL DEFAULT NULL COMMENT '开始配置项id',
  `type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '关联方式，当cientityid不为空时才有效，invoke代表更新自己的表达式属性，invoked代表更新关联配置项的表达式属性',
  `server_id` int NULL DEFAULT NULL COMMENT '服务器id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_attrexpression_rebuild_audit';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_attrexpression_rel';
...
CREATE TABLE `cmdb_ci`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '英文名',
  `label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '中文名',
  `description` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
  `icon` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图标',
  `type_id` bigint NULL DEFAULT NULL COMMENT '类型ID ecmdb_ci_type',
  `parent_ci_id` bigint NULL DEFAULT NULL COMMENT '父模型ID',
  `name_attr_id` bigint NULL DEFAULT NULL COMMENT '名称属性',
  ...
  `file_id` bigint NULL DEFAULT NULL COMMENT '虚拟模型配置文件id',
  `xml` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '虚拟模型配置内容',
  `expired_day` int NULL DEFAULT 0 COMMENT '有效天数，0代表不超期',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_enname`(`name`) USING BTREE,
  INDEX `idx_lft`(`lft`) USING BTREE,
  INDEX `idx_rht`(`rht`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb配置项表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb配置项授权表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '配置模型自定义视图关联表';
...
CREATE TABLE `cmdb_ci_group`  (
  `id` bigint NOT NULL COMMENT 'id',
  `ci_id` bigint NULL DEFAULT NULL COMMENT '模型id',
  `group_id` bigint NULL DEFAULT NULL COMMENT '团体id',
  `rule` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '规则',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_ci_id`(`ci_id`, `group_id`) USING BTREE,
  INDEX `idx_group_id`(`group_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '模型团体关系表';

-- ----------------------------
-- Table structure for cmdb_ci_tree
-- ----------------------------
CREATE TABLE `cmdb_ci_tree`  (
  `ci_id` bigint NOT NULL,
  `parent_ci_id` bigint NULL DEFAULT NULL,
...
CREATE TABLE `cmdb_ci_unique`  (
  ...
  INDEX `idx_attr_id`(`attr_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_ci_unique';
...
CREATE TABLE `cmdb_cientity`  (
  ...
  `fcu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `fcd` timestamp(3) NULL DEFAULT NULL COMMENT '创建时间',
  `lcu` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改用户',
  `lcd` timestamp(3) NULL DEFAULT NULL COMMENT '修改时间',
  `inspect_status` enum('normal','warn','critical','','fatal') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '巡检状态',
  `inspect_time` timestamp(3) NULL DEFAULT NULL COMMENT '巡检时间',
  `monitor_status` enum('normal','warn','critical','','fatal') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '监控状态',
  `monitor_time` timestamp(3) NULL DEFAULT NULL COMMENT '监控时间',
  `renew_time` timestamp(3) NULL DEFAULT NULL COMMENT '刷新时间，用来判断是否老化',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_ci_id`(`ci_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb配置项实例表';
...
CREATE TABLE `cmdb_cientity_expiredtime`  (
  ...
  `expired_day` int NULL DEFAULT NULL COMMENT '原来的超时天数，用于比对修正expired_time',
...
-- ----------------------------
CREATE TABLE `cmdb_cientity_globalattritem`  (
...
CREATE TABLE `cmdb_cientity_group`  (
  ...
  `ci_group_id` bigint NULL DEFAULT NULL COMMENT '命中的规则id',
  PRIMARY KEY (`group_id`, `cientity_id`) USING BTREE,
  INDEX `idx_ci_group_id`(`ci_group_id`) USING BTREE,
  INDEX `idx_cientity_id`(`cientity_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '配置项团体关系表';
...
CREATE TABLE `cmdb_cientity_illegal`  (
  ...
  INDEX `idx_legalvalid_id`(`legalvalid_id`) USING BTREE,
  INDEX `idx_ci_id`(`ci_id`) USING BTREE,
  INDEX `idx_time`(`valid_time`) USING BTREE,
  INDEX `idx_cientity_id`(`cientity_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '非法配置项';
...
CREATE TABLE `cmdb_cientity_inspect`  (
  ...
  `inspect_time` timestamp(3) NULL DEFAULT NULL COMMENT '巡检时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_job_id_cientity_id`(`job_id`, `ci_entity_id`) USING BTREE,
  INDEX `idx_cientity_id`(`ci_entity_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '配置项的巡检状态表';
...
CREATE TABLE `cmdb_cientity_snapshot`  (
  ...
  `content` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '内容',
  PRIMARY KEY (`hash`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb配置项实例快照表';
...
CREATE TABLE `cmdb_cientity_transaction`  (
  ...
  `ci_entity_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '配置项实例uuid',
  `ci_id` bigint NOT NULL COMMENT '引用ecmdb_ci的id',
  ...
  `snapshot` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '修改前快照hash',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_NewIndex1`(`transaction_id`) USING BTREE,
  INDEX `idx_NewIndex2`(`ci_entity_id`) USING BTREE,
  INDEX `idx_NewIndex3`(`ci_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb配置项实例事务表';
...
CREATE TABLE `cmdb_citype`  (
  ...
  `is_showintopo` tinyint(1) NULL DEFAULT NULL COMMENT '是否在topo图中展示',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb配置项类型表';
...
CREATE TABLE `cmdb_customview`  (
  ...
  `is_private` tinyint(1) NULL DEFAULT NULL COMMENT '是否私有视图',
  `type` enum('private','public','scene') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '类型',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '说明',
  `icon` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '图标',
  `fcu` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '所有人uuid',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb自定义视图表';
...
CREATE TABLE `cmdb_customview_attr`  (
  ...
  `is_primary` tinyint NULL DEFAULT 0 COMMENT '是否主键',
  `condition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '条件，json结构',
  PRIMARY KEY (`customview_id`, `uuid`) USING BTREE,
  INDEX `idx_attr_id`(`attr_id`) USING BTREE,
  INDEX `idx_customviewci_id`(`customview_ci_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb自定义视图属性表';
...
CREATE TABLE `cmdb_customview_auth`  (
  ...
  INDEX `idx_customview_id`(`customview_id`) USING BTREE,
  INDEX `idx_auth_uuid`(`auth_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '自定义视图授权表';
...
CREATE TABLE `cmdb_customview_ci`  (
  ...
  `is_hidden` tinyint(1) NULL DEFAULT NULL COMMENT '是否在topo中展示',
  ...
  `is_start` tinyint(1) NULL DEFAULT NULL COMMENT '是否起始模型',
  PRIMARY KEY (`customview_id`, `uuid`) USING BTREE,
  INDEX `idx_ci_id`(`ci_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_customview_ci';
...
CREATE TABLE `cmdb_customview_constattr`  (
  ...
  `customview_ci_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '模型在视图中的唯一id',
  `uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'uuid',
  `const_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '属性名称',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '唯一标识',
  `alias` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '别名',
  `sort` int NULL DEFAULT NULL COMMENT '顺序',
  `is_hidden` tinyint NULL DEFAULT 0 COMMENT '是否隐藏',
  `is_primary` tinyint NULL DEFAULT 0 COMMENT '是否主键',
  PRIMARY KEY (`customview_id`, `uuid`) USING BTREE,
  INDEX `idx_attr_id`(`const_name`) USING BTREE,
  INDEX `idx_customviewci_id`(`customview_ci_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '视图属性配置';
...
CREATE TABLE `cmdb_customview_link`  (
  ...
  `uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'uuid',
  `from_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '源视图uuid',
  `to_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '目标视图uuid',
  `from_type` enum('attr','rel','ci','constattr') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '来源类型',
  `to_type` enum('attr','rel','ci','constattr') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '目标类型',
  `join_type` enum('join','leftjoin','rightjoin','outerjoin') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '连接方式',
  `from_ci_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '源配置项uuid',
  `to_ci_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '目标配置项uuid',
  PRIMARY KEY (`customview_id`, `uuid`) USING BTREE,
  INDEX `idx_view_id`(`from_uuid`) USING BTREE,
  INDEX `idx_to_attr_id`(`from_type`) USING BTREE,
  INDEX `idx_fromcustomviewci_id`(`to_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb自定义视图关联表';
...
CREATE TABLE `cmdb_customview_rel`  (
  `customview_id` bigint NOT NULL COMMENT '视图id',
  `customview_ci_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'customview_ci_uuid',
  `uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'uuid',
  `rel_id` bigint NULL DEFAULT NULL COMMENT 'rel_id',
  PRIMARY KEY (`customview_id`, `uuid`) USING BTREE,
  INDEX `idx_customci_uuid`(`customview_ci_uuid`) USING BTREE,
  INDEX `idx_rel_id`(`rel_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_customview_rel';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb自定义视图标签表';
...
CREATE TABLE `cmdb_customview_template`  (
  ...
  `config` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '配置',
  `template` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '内容模板',
  `is_active` tinyint(1) NULL DEFAULT NULL COMMENT '是否激活',
  PRIMARY KEY (`customview_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb自定义视图模板\r\n';

-- ----------------------------
-- Table structure for cmdb_global_attr
-- ----------------------------
CREATE TABLE `cmdb_global_attr`  (
  `id` bigint NOT NULL COMMENT 'Id',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '唯一标识',
  ...
  `is_private` tinyint NULL DEFAULT NULL COMMENT '私有属性不能编辑和删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_name`(`name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
-- ----------------------------
CREATE TABLE `cmdb_global_attritem`  (
  `id` bigint NOT NULL,
...
CREATE TABLE `cmdb_graph`  (
  ...
  `type` enum('private','public','scene') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `cmdb_graph_rel`  (
  ...
  INDEX `idx_to_graph_id`(`to_graph_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE `cmdb_group`  (
  ...
  `type` enum('readonly','maintain','autoexec') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '类型',
  `is_active` tinyint NULL DEFAULT NULL COMMENT '是否激活',
  `cientity_count` int NULL DEFAULT NULL COMMENT '配置项数量',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '团体';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_group_auth';
...
CREATE TABLE `cmdb_import_audit`  (
  `id` bigint NOT NULL COMMENT 'ID',
  `import_user` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '导入用户',
  `import_date` timestamp(3) NULL DEFAULT NULL COMMENT '导入时间',
  `finish_date` timestamp(3) NULL DEFAULT NULL COMMENT '完成时间',
  `action` enum('append','update','all') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'append：增量导入；update：存量导入；all：全部导入',
  `file_id` bigint NULL DEFAULT NULL COMMENT '导入附件的id',
  `ci_id` bigint NULL DEFAULT NULL COMMENT '引用cmdb_ci的id',
  `success_count` int NULL DEFAULT NULL COMMENT '导入数量',
  `failed_count` int NULL DEFAULT NULL COMMENT '失败数量',
  `status` enum('running','success','failed') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '状态',
  ...
  `server_id` int NULL DEFAULT NULL COMMENT '应用ID',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_import_date`(`import_date`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb批量导入审计表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_import_file';
...
CREATE TABLE `cmdb_legalvalid`  (
  `id` bigint NOT NULL COMMENT 'id',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '名称',
  `type` enum('ci','custom') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '校验类型',
  `ci_id` bigint NULL DEFAULT NULL COMMENT '模型id',
  `rule` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '规则',
  `cron` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '定时表达式',
  `is_active` tinyint(1) NULL DEFAULT NULL COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_ci_id`(`ci_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '合规设置表';
...
CREATE TABLE `cmdb_rel`  (
  ...
  `from_group_id` bigint NULL DEFAULT NULL COMMENT '来源端分组,引用cmdb_relgroup的id',
  `from_is_unique` tinyint NULL DEFAULT NULL COMMENT '来源引用是否唯一',
  `from_is_cascade_delete` tinyint NULL DEFAULT 0 COMMENT '来源端是否级联删除',
  `from_is_required` tinyint NULL DEFAULT NULL COMMENT '来源端是否必填',
  ...
  `to_group_id` bigint NULL DEFAULT NULL COMMENT '目标端分组,引用cmdb_relgroup的id',
  `to_is_unique` tinyint NULL DEFAULT NULL COMMENT '目标引用是否唯一',
  `to_is_cascade_delete` tinyint NULL DEFAULT 0 COMMENT '目标端是否级联删除',
  `to_is_required` tinyint NULL DEFAULT NULL COMMENT '目标端是否必填',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_from_to_name`(`from_name`, `to_name`) USING BTREE,
  UNIQUE INDEX `uk_fromlabel_tolabel`(`from_label`, `to_label`) USING BTREE,
  INDEX `idx_from_ciid`(`from_ci_id`) USING BTREE,
  INDEX `idx_to_ciid`(`to_ci_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'CI关联类型表';
...
CREATE TABLE `cmdb_relativerel`  (
  ...
  `from_path` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '上游端路径',
  `to_path` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '下游端路径',
  ...
  UNIQUE INDEX `uk_path`(`path_hash`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb引用关系';
...
CREATE TABLE `cmdb_relentity`  (
  ...
  `transaction_id` bigint NULL DEFAULT NULL COMMENT '生效事务id',
  `from_index` int NULL DEFAULT NULL COMMENT '数据序号，用于检索时提高效率，只会生成前N条数据的序号',
  `to_index` int NULL DEFAULT NULL COMMENT '数据序号，用于检索时提高效率，只会生成前N条数据的序号',
  `insert_time` timestamp(3) NULL DEFAULT NULL COMMENT '插入时间',
  `renew_time` timestamp(3) NULL DEFAULT NULL COMMENT '更新时间，用于判断老化',
  `valid_day` int NULL DEFAULT NULL COMMENT '有效天数，为空代表长期有效',
  `expired_time` timestamp(3) NULL DEFAULT NULL COMMENT '过期日期',
  `relativerel_hash` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '关联关系hash',
  `source_relentity_id` bigint NULL DEFAULT NULL COMMENT '源头关系id，不为空代表是级联关系，源头关系删除后这条关系也要删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_from_to`(`rel_id`, `from_cientity_id`, `to_cientity_id`) USING BTREE,
  INDEX `idx_from_cientity_id`(`from_cientity_id`) USING BTREE,
  INDEX `idx_to_cientity_id`(`to_cientity_id`) USING BTREE,
  INDEX `idx_from_index`(`rel_id`, `from_cientity_id`, `from_index`) USING BTREE,
  INDEX `idx_to_index`(`rel_id`, `to_cientity_id`, `to_index`) USING BTREE,
  INDEX `idx_expiredtime`(`expired_time`) USING BTREE,
  INDEX `idx_source_relentity_id`(`source_relentity_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb配置项实例关联表';
...
CREATE TABLE `cmdb_relgroup`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_group_name`(`ci_id`, `name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_relgroup';
...
CREATE TABLE `cmdb_reltype`  (
  ...
  `from_cnname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '调用方名称',
  `to_cnname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '目标方名称',
  `from_enname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '调用方英文名',
  `to_enname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '目标方英文名',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_name`(`name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_reltype';
...
CREATE TABLE `cmdb_resourcecenter_account`  (
  ...
  `lcu` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
  `lcd` timestamp NULL DEFAULT NULL COMMENT '修改时间',
  `is_default` tinyint(1) NULL DEFAULT 0 COMMENT '是否该协议默认账号',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX ` idx_protocolid`(`protocol_id`) USING BTREE,
  INDEX `idx_name`(`name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb资源中心账号表';
...
CREATE TABLE `cmdb_resourcecenter_account_protocol`  (
  ...
  `port` int NULL DEFAULT NULL COMMENT '协议端口',
  `fcd` timestamp(3) NULL DEFAULT NULL COMMENT '创建时间',
  `fcu` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb资源中心账号协议表';
...
CREATE TABLE `cmdb_resourcecenter_account_tag`  (
  ...
  INDEX `idx_tag_id`(`tag_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_resourcecenter_account_tag';
...
CREATE TABLE `cmdb_resourcecenter_config`  (
  ...
  `lcd` timestamp(3) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '资源中心配置表';
...
CREATE TABLE `cmdb_resourcecenter_entity`  (
  ...
  `label` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '标识',
  `type` enum('resource','scene') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '类型',
  `status` enum('ready','pending','error','') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '状态',
  `error` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'error',
  `xml` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '配置信息',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '描述',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_resourcecenter_entity';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '资源中心资源与账号关联表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_resourcecenter_resource_tag';
...
CREATE TABLE `cmdb_resourcecenter_type_ci`  (
  `ci_id` bigint NOT NULL COMMENT '模型id',
  PRIMARY KEY (`ci_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '资产清单树形模型';
...
CREATE TABLE `cmdb_schema_audit`  (
  ...
  `action` enum('insert','delete','update') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '动作',
  `lcd` timestamp(3) NULL DEFAULT NULL COMMENT '修改时间',
  `server_id` int NOT NULL COMMENT 'server id',
  `data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'data',
  `is_failed` tinyint(1) NULL DEFAULT 0 COMMENT '是否失败',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk`(`target_id`, `target_type`) USING BTREE,
  INDEX `idx_lcd`(`lcd`) USING BTREE,
  INDEX `idx_server_id`(`server_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 98 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_schema_audit';
...
CREATE TABLE `cmdb_sync_audit`  (
  `id` bigint NOT NULL COMMENT 'id',
  `ci_collection_id` bigint NULL DEFAULT NULL COMMENT '同步配置id',
  `start_time` timestamp(3) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` timestamp(3) NULL DEFAULT NULL COMMENT '结束时间',
  `data_count` int NULL DEFAULT NULL COMMENT '需处理的数据量',
  `input_from` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '触发方式',
  `status` enum('doing','done') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '状态',
  `transaction_group_id` bigint NULL DEFAULT NULL COMMENT '事务组id',
  `server_id` int NULL DEFAULT NULL COMMENT '服务器id',
  `error` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '异常',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_ci_collection_id`(`ci_collection_id`) USING BTREE,
  INDEX `idx_start_time`(`start_time`) USING BTREE,
  INDEX `idx_end_time`(`end_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb同步记录表';
...
CREATE TABLE `cmdb_sync_ci_collection`  (
  ...
  `parent_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '父属性，可以为空',
  `collect_mode` enum('initiative','passive') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'collect mode',
  `is_auto_commit` tinyint NULL DEFAULT NULL COMMENT '是否自动提交',
  `is_allow_multiple` tinyint NULL DEFAULT NULL COMMENT '是否允许更新多条数据',
  ...
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '说明',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk`(`ci_id`, `collection_name`, `parent_key`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_sync_ci_collection';
...
CREATE TABLE `cmdb_sync_mapping`  (
  `id` bigint NOT NULL COMMENT 'id',
  `ci_collection_id` bigint NULL DEFAULT NULL COMMENT '模型集合id',
  `rel_id` bigint NULL DEFAULT NULL COMMENT '关系id',
  `direction` enum('from','to') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '关系方向',
  `global_attr_id` bigint NULL DEFAULT NULL COMMENT '全局属性id',
  `attr_id` bigint NULL DEFAULT NULL COMMENT '属性id',
  `field` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '集合字段，支持jsonpath',
  `action` enum('insert','replace','delete','update','merge') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'insert' COMMENT '动作',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb_sync_mapping';

-- ----------------------------
-- Table structure for cmdb_sync_objtype
-- ----------------------------
CREATE TABLE `cmdb_sync_objtype`  (
  `id` bigint NOT NULL,
  `obj_category` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '对象大类',
  `obj_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '对象小类',
  `ci_id` bigint NULL DEFAULT NULL COMMENT '模型id',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_obj`(`obj_category`, `obj_type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE `cmdb_sync_policy`  (
  `id` bigint NOT NULL COMMENT '主键',
  `ci_collection_id` bigint NULL DEFAULT NULL COMMENT '模型id',
  `ci_id` bigint NULL DEFAULT NULL COMMENT '模型id',
  `is_active` tinyint(1) NULL DEFAULT NULL COMMENT '是否激活',
  `condition` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT 'mongodb过滤条件',
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '名称',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_ci_id`(`ci_collection_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb同步策略';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb同步计划表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '配置同步唯一属性';
...
CREATE TABLE `cmdb_tag`  (
  ...
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '描述',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb标签表';
...
CREATE TABLE `cmdb_topo_template`  (
  ...
  INDEX `idx_ci`(`ci_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci;
...
CREATE TABLE `cmdb_transaction`  (
  ...
  `ci_id` bigint NULL DEFAULT NULL COMMENT '模型id',
  `status` enum('commited','uncommit','recover') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '是否提交',
  `create_user` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建用户ID',
  `commit_user` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '提交用户ID',
  `recover_user` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '恢复用户',
  `input_from` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '数据来源类型',
  ...
  `error` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '最后一次错误原因',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改备注',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_commit_time`(`commit_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb事务表';
...
CREATE TABLE `cmdb_transactiongroup`  (
  ...
  INDEX `idx_transaction_id`(`transaction_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb事务组表';
...
CREATE TABLE `cmdb_validator`  (
  ...
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
  `error_template` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '错误模版',
  `is_active` tinyint(1) NULL DEFAULT NULL COMMENT '是否激活',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb校验器表';
...
CREATE TABLE `cmdb_view`  (
  ...
  `allow_edit` tinyint(1) NULL DEFAULT NULL COMMENT '允许修改',
  `alias` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '别名',
  PRIMARY KEY (`ci_id`, `item_id`, `type`) USING BTREE,
  INDEX `idx_item_id`(`item_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb视图表';
...
CREATE TABLE `cmdb_viewconst`  (
  `id` bigint NOT NULL COMMENT 'id',
  `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '名称',
  `label` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '显示名',
  `sort` int NULL DEFAULT NULL COMMENT '排序',
