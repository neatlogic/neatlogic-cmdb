...
(
    `customview_id` bigint                                                                       NOT NULL COMMENT '视图id',
    `auth_type`     enum ('user','team','role') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '\'user\',\'team\',\'role\'',
    `auth_uuid`     char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci                    NOT NULL COMMENT 'auth uuid',
...
(
    ...
    `type`           enum ('readonly','maintain') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '类型',
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '用于ip账号匹配'
  ROW_FORMAT = Dynamic;
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE,
    UNIQUE INDEX `uniq_name_port` (`name`, `port`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
(
    ...
    `action`           enum ('insert','replace','delete') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'insert' COMMENT '动作',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB
  CHARACTER SET = utf8mb4
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '自动发现关联组合工具表' ROW_FORMAT = Dynamic;
