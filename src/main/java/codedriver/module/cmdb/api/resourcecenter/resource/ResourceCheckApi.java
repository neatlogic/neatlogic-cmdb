...
//                        resourceId = resourceCenterMapper.getResourceId(sql);
...
//    private String getResourceIdByIpAndPortAndNameWithFilter(ResourceSearchVo searchVo) {
//        List<ResourceEntityVo> resourceEntityList = resourceCenterResourceService.getResourceEntityList();
...
//        String mainResourceId = "resource_ipobject";
...
//        filterPlainSelect.setSelectItems(Arrays.asList((new SelectExpressionItem(new Column(mainTable, "id")))));
...
//        filterPlainSelect.withLimit(new Limit().withOffset(new LongValue(0)).withRowCount(new LongValue(1)));
...
//            if (resourceSearchGenerateSqlUtil.additionalInformation(resourceInfo)) {
//                Column column = resourceSearchGenerateSqlUtil.addJoinTableByResourceInfo(resourceInfo, plainSelect);
//                EqualsTo equalsTo = new EqualsTo(column, new StringValue(name));
//                Expression where = plainSelect.getWhere();
//                if (where == null) {
...
//            }
//        }
//        String ip = searchVo.getIp();
//        if (StringUtils.isNotBlank(ip)) {
//            ResourceInfo resourceInfo = searchConditionMappingMap.get("ip");
//            if (resourceSearchGenerateSqlUtil.additionalInformation(resourceInfo)) {
//                Column column = resourceSearchGenerateSqlUtil.addJoinTableByResourceInfo(resourceInfo, plainSelect);
//                EqualsTo equalsTo = new EqualsTo(column, new StringValue(ip));
//                Expression where = plainSelect.getWhere();
//                if (where == null) {
//                    plainSelect.setWhere(equalsTo);
//                } else {
...
//            }
//        }
//        String port = searchVo.getPort();
//        ResourceInfo resourceInfo = searchConditionMappingMap.get("port");
//        if (resourceSearchGenerateSqlUtil.additionalInformation(resourceInfo)) {
//            Column column = resourceSearchGenerateSqlUtil.addJoinTableByResourceInfo(resourceInfo, plainSelect);
//            Expression expression = null;
//            if (StringUtils.isNotBlank(port)) {
//                expression = new EqualsTo(column, new StringValue(port));
//            } else {
//                expression = new IsNullExpression().withLeftExpression(column);
//            }
//            Expression where = plainSelect.getWhere();
//            if (where == null) {
