...
public class ResourceAccountGetPublicApi extends PublicApiComponentBase {
    ...
    public Object myDoService(JSONObject paramObj) throws Exception {
        return resourceCenterMapper.getResourceAccountByResourceIdAndProtocolAndProtocolPortAndAccount(paramObj.getLong("resourceId"),paramObj.getString("protocol"),paramObj.getInteger("protocolPort"),paramObj.getString("username"));
    }
}
