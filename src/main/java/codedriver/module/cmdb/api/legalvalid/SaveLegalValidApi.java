...
import codedriver.framework.cmdb.exception.legalvalid.LegalValidNotFoundException;
...
public class SaveLegalValidApi extends PrivateApiComponentBase {
    ...
    public Object myDoService(JSONObject jsonObj) throws Exception {
        ...
        if (StringUtils.isNotEmpty(legalValidVo.getCron())) {
            IJob handler = SchedulerManager.getHandler("codedriver.module.cmdb.schedule.handler.LegalValidScheduleJob");
