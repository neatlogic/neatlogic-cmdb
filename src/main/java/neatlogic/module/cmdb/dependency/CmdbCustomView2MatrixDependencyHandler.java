...
@Component
public class CmdbCustomView2MatrixDependencyHandler extends CustomDependencyHandlerBase {
    ...
    protected String getTableName() {
        return "matrix_cmdb_custom_view";
    }
...
//                String pathFormat = "矩阵-${DATA.matrixName}";
    ...
    public IFromType getFromType() {
        return CmdbFromType.CMDBCUSTOMVIEW;
    }
}
