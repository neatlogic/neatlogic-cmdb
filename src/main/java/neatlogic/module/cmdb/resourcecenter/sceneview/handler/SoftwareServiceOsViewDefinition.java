...
//        }
    ...
    public List<SceneViewFieldVo> getFieldList() {
        if (CollectionUtils.isEmpty(fieldList)) {
            ...
            fieldList.add(new SceneViewFieldVo("os_id", "系统ID", true));
            fieldList.add(new SceneViewFieldVo("os_name", "系统名称", true));
        }
