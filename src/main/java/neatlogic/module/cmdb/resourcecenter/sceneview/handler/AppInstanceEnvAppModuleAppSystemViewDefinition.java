...
@Component
public class AppInstanceEnvAppModuleAppSystemViewDefinition implements ISceneViewDefinition {

    private final List<SceneViewFieldVo> fieldList = new ArrayList<>();
    private final List<String> functionPathList = new ArrayList<>();
    @Override
    public String getName() {
        return "scence_appinstance_env_appmodule_appsystem";
    }

    @Override
    public String getLabel() {
        return "应用实例环境和模块及应用场景";
    }
