...
@Component
public class OsSoftwareServiceEnvAppModuleAppSystemViewDefinition implements ISceneViewDefinition {

    private final List<SceneViewFieldVo> fieldList = new ArrayList<>();
    private final List<String> functionPathList = new ArrayList<>();
    @Override
    public String getName() {
        return "scence_os_softwareservice_env_appmodule_appsystem";
    }

    @Override
    public String getLabel() {
        return "操作系统与软件服务、环境、模块及应用场景";
    }
    ...
    public List<SceneViewFieldVo> getFieldList() {
        if (CollectionUtils.isEmpty(fieldList)) {
            ...
            fieldList.add(new SceneViewFieldVo("resource_id", "资产id", true));
