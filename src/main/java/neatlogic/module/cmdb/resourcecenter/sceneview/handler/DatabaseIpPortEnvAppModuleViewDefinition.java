...
@Component
public class DatabaseIpPortEnvAppModuleViewDefinition implements ISceneViewDefinition {

    private final List<SceneViewFieldVo> fieldList = new ArrayList<>();
    private final List<String> functionPathList = new ArrayList<>();
    @Override
    public String getName() {
        return "scence_database_ip_port_env_appmodule";
    }

    @Override
    public String getLabel() {
        return "DB库IP端口环境和模块场景";
    }
