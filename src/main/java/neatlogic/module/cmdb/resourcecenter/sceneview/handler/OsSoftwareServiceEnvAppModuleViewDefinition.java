...
@Component
public class OsSoftwareServiceEnvAppModuleViewDefinition implements ISceneViewDefinition {

    private final List<SceneViewFieldVo> fieldList = new ArrayList<>();
    private final List<String> functionPathList = new ArrayList<>();
    @Override
    public String getName() {
        return "scence_os_softwareservice_env_appmodule";
    }

    @Override
    public String getLabel() {
        return "操作系统与软件服务、环境、模块场景";
    }
