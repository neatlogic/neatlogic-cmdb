...
//        }
    ...
    public List<SceneViewFieldVo> getFieldList() {
        if (CollectionUtils.isEmpty(fieldList)) {
            ...
            fieldList.add(new SceneViewFieldVo("service_ports_id", "service_ports_id", true));
            fieldList.add(new SceneViewFieldVo("name", "名称", true));
            fieldList.add(new SceneViewFieldVo("listen_port", "listen_port", true));
        }
