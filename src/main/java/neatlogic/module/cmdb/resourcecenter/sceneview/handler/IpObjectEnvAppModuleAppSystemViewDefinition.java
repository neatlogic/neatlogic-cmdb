...
@Component
public class IpObjectEnvAppModuleAppSystemViewDefinition implements ISceneViewDefinition {

    private final List<SceneViewFieldVo> fieldList = new ArrayList<>();
    private final List<String> functionPathList = new ArrayList<>();
    @Override
    public String getName() {
        return "scence_ipobject_env_appmodule_appsystem";
    }

    @Override
    public String getLabel() {
        return "IP软硬件环境和模块及应用场景";
    }
