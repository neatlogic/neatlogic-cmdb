...
@Component
public class AppInstanceIpPortEnvAppModuleViewDefinition implements ISceneViewDefinition {

    private final List<SceneViewFieldVo> fieldList = new ArrayList<>();
    private final List<String> functionPathList = new ArrayList<>();
    @Override
    public String getName() {
        return "scence_appinstance_ip_port_env_appmodule";
    }

    @Override
    public String getLabel() {
        return "应用实例IP端口环境和模块场景";
    }
